...
export const demoServices: HassServices = {
  homeassistant: {
    ...
    stop: { description: "Stop the RiverOS service.", fields: {} },
    restart: { description: "Restart the RiverOS service.", fields: {} },
    check_config: {
      description:
        "Check the RiverOS configuration files for errors. Errors will be displayed in the RiverOS log.",
      fields: {},
    },
    update_entity: {
